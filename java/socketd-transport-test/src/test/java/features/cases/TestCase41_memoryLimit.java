 ...
 * @since 2.0
 */
public class TestCase41_memoryLimit extends BaseTestCase {
    private static Logger log = LoggerFactory.getLogger(TestCase41_memoryLimit.class);

    public TestCase41_memoryLimit(String schema, int port) {
        super(schema, port);
    }
