 ...
 * @since 2.0
 */
public class TestCase33_client_preclose extends BaseTestCase {
    private static Logger log = LoggerFactory.getLogger(TestCase33_client_preclose.class);

    public TestCase33_client_preclose(String schema, int port) {
        super(schema, port);
    }
