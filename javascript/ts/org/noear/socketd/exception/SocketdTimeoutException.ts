...
namespace org.noear.socketd.exception {
     ...
     */
    export class SocketdTimeoutException extends org.noear.socketd.exception.SocketdException {
    ...
    SocketdTimeoutException["__class"] = "org.noear.socketd.exception.SocketdTimeoutException";
