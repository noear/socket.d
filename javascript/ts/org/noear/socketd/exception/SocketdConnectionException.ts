...
namespace org.noear.socketd.exception {
     ...
     */
    export class SocketdConnectionException extends org.noear.socketd.exception.SocketdException {
    ...
    SocketdConnectionException["__class"] = "org.noear.socketd.exception.SocketdConnectionException";
