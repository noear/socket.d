 ...
 * @since 2.0
 */
public class TestCase38_clientCloseSelf extends BaseTestCase {
    private static Logger log = LoggerFactory.getLogger(TestCase38_clientCloseSelf.class);

    public TestCase38_clientCloseSelf(String schema, int port) {
        super(schema, port);
    }
