 ...
 * @since 2.0
 */
public class TestCase30_meta_auth extends BaseTestCase {
    private static Logger log = LoggerFactory.getLogger(TestCase30_meta_auth.class);

    public TestCase30_meta_auth(String schema, int port) {
        super(schema, port);
    }
