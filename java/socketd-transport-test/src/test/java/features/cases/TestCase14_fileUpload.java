 ...
 * @since 2.0
 */
public class TestCase14_fileUpload extends BaseTestCase {
    private static Logger log = LoggerFactory.getLogger(TestCase14_fileUpload.class);

    public TestCase14_fileUpload(String schema, int port) {
        super(schema, port);
    }
