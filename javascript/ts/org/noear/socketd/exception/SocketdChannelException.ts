...
namespace org.noear.socketd.exception {
     ...
     */
    export class SocketdChannelException extends org.noear.socketd.exception.SocketdException {
    ...
    SocketdChannelException["__class"] = "org.noear.socketd.exception.SocketdChannelException";
