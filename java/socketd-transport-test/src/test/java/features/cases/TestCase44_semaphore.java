 ...
 * @since 2.0
 */
public class TestCase44_semaphore extends BaseTestCase {
    private static Logger log = LoggerFactory.getLogger(TestCase44_semaphore.class);

    public TestCase44_semaphore(String schema, int port) {
        super(schema, port);
    }
