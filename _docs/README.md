...
| 对比项目 | socketd | netty  | smart-socket | tio    | websocket | java-socket | rsocket |
|------|---------|--------|------------|--------|-----------|-------------|--------|
| 形象比喻 | 面粉      | 熟麦子    | 熟麦子        | 熟麦子    | 干麦子       | 生麦子         | 面粉      |
| 项目类型 | (通讯协议)  | 通讯开发框架 | 通讯开发框架     | 通讯开发框架 | (通讯协议)    | 基础接口        | (通讯协议) | 
| 学习难度 | 非常简单    | 难      | 易  | 易      | 中         | 中           | 难      |
| 上手难度 | 非常简单    | 中      | 中 | 中      | 中         | 难           | 难      |


如果你要做面包、面条，用麦粉更方便。用麦子需要晒干，还要磨成粉（这个难易，是从做面包的角度）。
