...
const Asserts_1 = __webpack_require__(1);
const ClientConfig_1 = __webpack_require__(5);
const ClusterClient_1 = __webpack_require__(18);
const WsClientProvider_1 = __webpack_require__(21);
const Entity_1 = __webpack_require__(11);
const Listener_1 = __webpack_require__(25);
...
class SocketD {
     ...
     * 创建事件监听器
     * */
    static newEventListener(routeSelector) {
        return new Listener_1.EventListener(routeSelector);
    }
    /**
     * 创建路径监听器（一般用于服务端）
     * */
    static newPathListener(routeSelector) {
 ...
 * 元信息字典
 * */
SocketD.Metas = Constants_1.EntityMetas;
SocketD.clientProviderMap = new Map();
(() => {
    const provider = new WsClientProvider_1.WsClientProvider();
    for (const s of provider.schemas()) {
        _a.clientProviderMap.set(s, provider);
    }
    const globalThisShim = _a.globalThisShim();
    globalThisShim.SocketD = _a;
})();
...
const Constants_1 = __webpack_require__(2);
const SocketdException_1 = __webpack_require__(4);
/**
 * 断言
 *
 * @author noear
...
const IdGenerator_1 = __webpack_require__(8);
const FragmentHandler_1 = __webpack_require__(10);
const Constants_1 = __webpack_require__(2);
const Asserts_1 = __webpack_require__(1);
const CodecByteBuffer_1 = __webpack_require__(17);
class ConfigBase {
    constructor(clientMode) {
        ...
        this._fragmentSize = Constants_1.Constants.MAX_SIZE_DATA;
        this._coreThreads = 2;
    ...
    idGenerator(idGenerator) {
        Asserts_1.Asserts.assertNull("idGenerator", idGenerator);
    ...
    fragmentHandler(fragmentHandler) {
        Asserts_1.Asserts.assertNull("fragmentHandler", fragmentHandler);
    ...
    fragmentSize(fragmentSize) {
        if (fragmentSize > Constants_1.Constants.MAX_SIZE_DATA) {
            throw new Error("The parameter fragmentSize cannot > 16m");
        }
        if (fragmentSize < Constants_1.Constants.MIN_FRAGMENT_SIZE) {
...
const StrUtils_1 = __webpack_require__(9);
class GuidGenerator {
    generate() {
...
const Entity_1 = __webpack_require__(11);
const Constants_1 = __webpack_require__(2);
const FragmentAggregator_1 = __webpack_require__(13);
/**
...
const StrUtils_1 = __webpack_require__(9);
const Codec_1 = __webpack_require__(12);
const Constants_1 = __webpack_require__(2);
const Buffer_1 = __webpack_require__(3);
const SocketdException_1 = __webpack_require__(4);
/**
...
class EntityDefault {
    constructor() {
        this._metaMap = null;
        this._data = Constants_1.Constants.DEF_DATA;
    ...
    dataSet(data) {
        if (data instanceof Blob) {
            this._data = new Buffer_1.BlobBuffer(data);
        }
        else {
            this._data = new Buffer_1.ByteBuffer(data);
        }
        return this;
    }
    /**
...
class FileEntity extends EntityDefault {
    constructor(file) {
        super();
        this.dataSet(file);
        this.metaPut(Constants_1.EntityMetas.META_DATA_DISPOSITION_FILENAME, file.name);
    }
}
...
const Message_1 = __webpack_require__(14);
const Entity_1 = __webpack_require__(11);
const Frame_1 = __webpack_require__(15);
const FragmentHolder_1 = __webpack_require__(16);
const Constants_1 = __webpack_require__(2);
const SocketdException_1 = __webpack_require__(4);
/**
 * 分片聚合器
...
const Constants_1 = __webpack_require__(2);
const Message_1 = __webpack_require__(14);
const SocketD_1 = __webpack_require__(0);
/**
 * 帧（帧[消息[实体]]）
 *
 * @author noear
...
const ClusterClientSession_1 = __webpack_require__(19);
const SocketD_1 = __webpack_require__(0);
/**
 * 集群客户端
 *
    ...
    async open() {
        ...
        for (const urls of this._serverUrls) {
            for (let url of urls.split(",")) {
                ...
                const client = SocketD_1.SocketD.createClient(url);
...
const StrUtils_1 = __webpack_require__(9);
const SocketdException_1 = __webpack_require__(4);
const RunUtils_1 = __webpack_require__(20);
/**
 * 集群客户端会话
 *
 * @author noear
...
class ClusterClientSession {
    constructor(sessions) {
        ...
        this._sessionId = StrUtils_1.StrUtils.guid();
    ...
    getSessionOne() {
        if (this._sessionSet.length == 0) {
            //没有会话
            throw new SocketdException_1.SocketdException("No session!");
        }
    ...
    close() {
        for (const session of this._sessionSet) {
            //某个关闭出错，不影响别的关闭
            RunUtils_1.RunUtils.runAndTry(session.close);
        }
    }
}
...
const WsClient_1 = __webpack_require__(22);
...
const WsChannelAssistant_1 = __webpack_require__(33);
const WsClientConnector_1 = __webpack_require__(34);
...
const Processor_1 = __webpack_require__(24);
const ClientChannel_1 = __webpack_require__(28);
const SessionDefault_1 = __webpack_require__(31);
/**
 * 客户端基类
 *
 * @author noear
...
const Constants_1 = __webpack_require__(2);
const SocketdException_1 = __webpack_require__(4);
const HandshakeDefault_1 = __webpack_require__(27);
...
const RouteSelector_1 = __webpack_require__(26);
/**
 * 简单监听器（一般用于占位）
 *
 * @author noear
...
const HeartbeatHandler_1 = __webpack_require__(30);
const Constants_1 = __webpack_require__(2);
const Asserts_1 = __webpack_require__(1);
const SocketdException_1 = __webpack_require__(4);
const RunUtils_1 = __webpack_require__(20);
...
const Session_1 = __webpack_require__(32);
const Message_1 = __webpack_require__(14);
const Frame_1 = __webpack_require__(15);
const Constants_1 = __webpack_require__(2);
const Stream_1 = __webpack_require__(7);
...
const ClientConnector_1 = __webpack_require__(35);
const WebSocketClientImpl_1 = __webpack_require__(36);
...
const ClientHandshakeResult_1 = __webpack_require__(37);
const ChannelDefault_1 = __webpack_require__(38);
const Constants_1 = __webpack_require__(2);
const SocketdException_1 = __webpack_require__(4);
