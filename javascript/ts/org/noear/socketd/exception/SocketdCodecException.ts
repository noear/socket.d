...
namespace org.noear.socketd.exception {
     ...
     */
    export class SocketdCodecException extends org.noear.socketd.exception.SocketdException {
    ...
    SocketdCodecException["__class"] = "org.noear.socketd.exception.SocketdCodecException";
